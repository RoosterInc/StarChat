...
/// Parse various timestamp formats from the backend.
/// Accepts ISO strings as well as compact forms like `YYYYMMDD_HHMM`.
DateTime _parseDateTime(dynamic value) {
  ...
  try {
    ...
    final reg = RegExp(r'^(\\d{4})(\\d{2})(\\d{2})[_-]?(\\d{2})(\\d{2})(\\d{2})?\$');
