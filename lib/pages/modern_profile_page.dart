...
class _ModernProfilePageState extends State<ModernProfilePage>
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildListDelegate([
                        _buildProfileHeader(
                            context, authController, userTypeController),
  ...
  Widget _buildProfileHeader(BuildContext context,
      AuthController authController, UserTypeController userTypeController) {
  ...
  Widget _buildUserTypeSection(
      BuildContext context, UserTypeController userTypeController) {
    return GlassmorphicCard(
      padding: DesignTokens.lg(context).all,
      child: Column(
  ...
  Future<void> _updateUserType(
      UserTypeController controller, String type) async {
