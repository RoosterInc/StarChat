          ...
          child: Stack(
            children: [
              ...
              ...List.generate(6, (index) {
                final offset =
                    (index * 60.0) + (_backgroundAnimation.value * 40);
                return Positioned(
    ...
    return Obx(() {
      ...
      if (!controller.isUsernameValid.value &&
        ...
        return _buildValidationCard(
          ...
          subtitle:
              'Username must be 3-15 characters with letters, numbers, and underscores only',
          color: Colors.red,
        );
      }
      ...
      if (controller.isUsernameValid.value &&
        ...
        return _buildValidationCard(
          context,
          icon:
              Icon(Icons.check_rounded, color: Colors.green.shade200, size: 20),
